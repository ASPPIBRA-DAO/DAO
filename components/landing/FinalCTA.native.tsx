...
const FinalCTA = () => {
  ...
  const isMobile = width < 768; // Em nativo, podemos considerar isso como o tamanho da tela
...
const styles = StyleSheet.create({
  ...
  title: {
    ...
    maxWidth: 600,
    marginBottom: 24,
    fontSize: 48, // Tamanho fixo para simplicidade, pode ser ajustado com base na tela
  },
  subtitle: {
    fontSize: 18,
  ...
  ctaButton: {
    backgroundColor: '#7B3EFC', // Cor específica do botão
    paddingVertical: 15,
